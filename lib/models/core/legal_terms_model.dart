...
② 만 19세 미만인 자는 서비스에 가입할 수 없습니다. (PASS 본인인증으로 자동 확인)
...
② 회원은 본인 명의로 가입한 계정(PASS 본인인증 기반)을 타인에게 양도·대여할 수 없습니다.
...
제9조 (분쟁 해결 및 관할)
① 서비스 이용과 관련한 분쟁은 고객센터(alfit@alfit.co.kr)를 통해 우선 해결합니다.
② 본 약관은 대한민국 법률에 따라 해석되며, 소송이 제기될 경우 회사 소재지를 관할하는 법원을 합의 관할 법원으로 합니다.

■ 시행일: 2026년 8월 1일''';

// [PRIVACY-FIX 2026-08-10] 이메일 alfit@alfit.co.kr로 통일, 카카오 위탁업체 추가, 아동 개인정보 조항 추가, 시행일 업데이트
...
(PASS 본인인증을 통해 자동 수집되며, 이용자가 직접 입력하지 않습니다)

[본인인증 결과 수집 항목]
CI(연계정보) — 동일인 식별을 위한 고유값, AES 암호화 저장
...
[수탁 업체 및 위탁 업무]
• 포트원(PortOne Inc.): PASS 본인인증 SDK 중계
• KG이니시스: PASS 본인인증 서비스 제공
...
• 개인정보 암호화: CI(연계정보), 주민등록번호 등 민감 정보는 AES 암호화 저장
...
본 서비스는 만 19세 이상 성인만 이용 가능합니다. PASS 본인인증 과정에서 만 19세 미만으로 확인될 경우 가입이 즉시 차단됩니다.
