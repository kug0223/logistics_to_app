...
///
/// [연결 완료] user_home_screen.dart Scaffold 상단에 삽입됨.
///   auth_service.dart signIn()에서 pending/rejected를 로그인 단계에서 차단하지만,
///   앱 실행 중 FCM 승인/거절 알림 수신 시 UserProvider 갱신 → 배너 즉시 반영.
